...
fn test_valid_linear_workflow() {
    ...
    let workflow = Workflow::new("w1", "Linear", "a")
        ...
        .with_step(Step::new("b", "tool2").with_edge(EdgeTarget::Step("c".into())))
        .with_step(Step::new("c", "tool3").with_edge(EdgeTarget::Return));
...
fn test_valid_diamond_workflow() {
    ...
    let workflow = Workflow::new("w2", "Diamond", "a")
        ...
        .with_step(Step::new("b", "tool2").with_edge(EdgeTarget::Step("d".into())))
        .with_step(Step::new("c", "tool3").with_edge(EdgeTarget::Step("d".into())))
        .with_step(Step::new("d", "tool4").with_edge(EdgeTarget::Return));
...
fn test_cycle_detection_simple() {
    ...
    let workflow = Workflow::new("w3", "Cycle", "a")
        .with_step(Step::new("a", "tool1").with_edge(EdgeTarget::Step("b".into())))
        .with_step(Step::new("b", "tool2").with_edge(EdgeTarget::Step("a".into())))
